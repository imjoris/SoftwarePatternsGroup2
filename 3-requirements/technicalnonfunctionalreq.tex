...
The system should make the increase in workload, resources and users easy to handle that's why the scalability its part of non functional requirements of the system.\\
 	...
 	\req{SCA} & The system should function as efficiently when the number of users increases. \\% increase in the number of users \\
 	\req{SCA} & The system should function as efficiently when the number of devices increases. \\ % percentage ?
 	}