...
\begin{table}[H]
	...
	Extensions &  \\
	Related requirements & \ref{fr:receive-usage}, \ref{fr:store-usage} \\
	}
...
\begin{table}[H]
	...
	Main success scenario & \compactList{enumerate}{%
		...
		\item The system computes the expected bill.
		\item The system shows the expected bill to the end user
		} \\
	Postcondition &  The estimated bill is displayed \\
	Extensions &  \\
	Related requirements & \ref{fr:compute-bill}, \ref{fr:web-interface} \\
	}
...
\begin{table}[H]
	...
	Main success scenario & \compactList{enumerate}{%
		...
		\item The user select the period for which to compute the statistic
		\item The system computes/make the analysis.
		\item The computed result is shown to the user.
		} \\
