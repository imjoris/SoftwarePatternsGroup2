...
\begin{longtable}{p{0.2\textwidth} p{0.7\textwidth} p{0.1\textwidth}}
	...
	Schaefers       & Meetings, researching patterns in the various books, describing front controller and command patterns& 9 \\ \midrule
	Menninga        & Meetings, feedback, working on Layers/Unit of Work/Service Layer patterns (ch. 3 \& 6), improved elaborated model & 12.5 \\ \bottomrule
\end{longtable}
