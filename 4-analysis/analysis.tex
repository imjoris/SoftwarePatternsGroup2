...
\centering
\includegraphics[]{4-analysis/images/ServiceLayer.jpg}
\end{figure}
...
\begin{description}
\item [Context]
The system does statistical analysis on the sensor data

\item [Problem]
Concurrent analysis functions might use the same object and data.
