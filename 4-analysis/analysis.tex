...
The service layer will offer the services of the system. There will be a service for collecting the electricity usage data and computing the statistics. There will also be a service for configuring the system (adding new devices, creating alerts etc.).
...
\textit{Architectural Pattern Revisited- A Pattern Language} \\
 ...
 \item [Issue]~\\ The external data must be stored, updaded, accessed by multiple users and servers simultaneously and analyzed.\\
 ...
 \item [Decision]~\\ The system uses the Shared Repository Pattern in order to centralize the access to the data.\\
